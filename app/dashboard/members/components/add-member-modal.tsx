    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/40 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl dark:border dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 px-6 py-5 dark:border-zinc-800">
          <div>
            <h2 className="text-lg font-semibold text-zinc-950 dark:text-white">Add New Member</h2>
            <p className="mt-1 text-sm text-zinc-500">Create a new member account</p>
          </div>
          <button
            type="button"
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          {/* Name */}
          <div>
            <label htmlFor="add-member-name" className="mb-2 block text-sm font-semibold text-zinc-900 dark:text-zinc-100">
          ...
          {/* Email */}
          <div>
            <label htmlFor="add-member-email" className="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-300">
          ...
          {/* Password */}
          <div>
            <label htmlFor="add-member-password" className="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-300">
              Password <span className="text-xs font-normal text-zinc-400">(defaults to password123)</span>
            </label>
            <input
          ...
          {/* Role */}
          <div>
            <label htmlFor="add-member-role" className="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-300">
              Role
            </label>
            <select
              id="add-member-role"
          ...
          {currentUserRole === "Super Admin" && (
            <div className="flex items-center justify-between rounded-xl border border-violet-200 bg-violet-50/60 p-3.5 dark:border-violet-900/50 dark:bg-violet-950/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <label htmlFor="add-member-committee" className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                    Committee Authority (isCommitteeMember)
                  </label>
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Appoints member to disciplinary committee with appeal adjudication power
                  </p>
                </div>
              </div>
              <input
                id="add-member-committee"
                type="checkbox"
          ...
          {/* Avatar URL */}
          <div>
            <label htmlFor="add-member-avatar" className="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-300">
